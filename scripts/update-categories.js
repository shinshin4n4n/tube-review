...
async function updateCategories() {
  ...
  try {
    ...
    if (entertainmentError) {
      ...
      console.log('✓ エンタメ系チャンネルを更新しました (8チャンネル)');
    }
    ...
    if (educationError) {
      ...
      console.log('✓ 教育系チャンネルを更新しました (2チャンネル)');
    }
    ...
    if (cookingError) {
      ...
      console.log('✓ 料理系チャンネルを更新しました (2チャンネル)');
    }
    ...
    if (vlogError) {
      ...
      console.log('✓ Vlog系チャンネルを更新しました (5チャンネル)');
    }
    ...
    console.log('\n✅ カテゴリーの更新が完了しました！');
    console.log('トップページからVlogカテゴリのチャンネルが表示できるようになりました。');
  } catch (error) {
    console.error('\n❌ エラーが発生しました:', error);
    process.exit(1);
  }
